...
//   const licenseIcon = document.getElementById("summaryLicenseIcon");
// document.querySelectorAll("#summaryLicense").forEach((el) => {
//   if (license === "Yes") {
//     el.textContent = "Yes, I Have a Driving Licence";
//     licenseIcon.classList.remove("no-license");
//     licenseIcon.classList.add("has-license");
//   } else if (license === "No") {
//     el.textContent = "No, I Don’t Have a Driving Licence";
//     licenseIcon.classList.remove("has-license");
//     licenseIcon.classList.add("no-license");
//   } else {
//     el.textContent = "";
//     licenseIcon.classList.remove("has-license", "no-license");
//   }
// });
...
document.querySelectorAll(".summaryLicenseIcon").forEach((icon) => {
  ...
  if (license === "Yes") {
    ...
    icon.classList.add("fas", "fa-check-square", "no-license");
  } else {
